...
#ifndef RUDP_OUTGOING_BUFFER_SIZE
#define RUDP_OUTGOING_BUFFER_SIZE 16
#endif
#ifdef CONFIG_LF_RUDP_OUTGOING_BUFFER_SIZE
#undef RUDP_OUTGOING_BUFFER_SIZE
#define RUDP_OUTGOING_BUFFER_SIZE CONFIG_LF_RUDP_OUTGOING_BUFFER_SIZE
#endif

#ifndef RUDP_INCOMING_BUFFER_SIZE
#define RUDP_INCOMING_BUFFER_SIZE 32
#endif
#ifdef CONFIG_LF_RUDP_INCOMING_BUFFER_SIZE
#undef RUDP_INCOMING_BUFFER_SIZE
#define RUDP_INCOMING_BUFFER_SIZE CONFIG_LF_RUDP_INCOMING_BUFFER_SIZE
#endif

#ifndef RUDP_RETRANSMIT_TIMEOUT_MS
#define RUDP_RETRANSMIT_TIMEOUT_MS 50
#endif
#ifdef CONFIG_LF_RUDP_RETRANSMIT_TIMEOUT_MS
#undef RUDP_RETRANSMIT_TIMEOUT_MS
#define RUDP_RETRANSMIT_TIMEOUT_MS CONFIG_LF_RUDP_RETRANSMIT_TIMEOUT_MS
#endif

#ifndef RUDP_MAX_RETRIES
#define RUDP_MAX_RETRIES 16
#endif
#ifdef CONFIG_LF_RUDP_MAX_RETRIES
#undef RUDP_MAX_RETRIES
#define RUDP_MAX_RETRIES CONFIG_LF_RUDP_MAX_RETRIES
#endif

#ifndef RUDP_IP_CHANNEL_RECV_THREAD_STACK_SIZE
#define RUDP_IP_CHANNEL_RECV_THREAD_STACK_SIZE 2048
#endif
#ifdef CONFIG_LF_RUDP_IP_CHANNEL_RECV_THREAD_STACK_SIZE
#undef RUDP_IP_CHANNEL_RECV_THREAD_STACK_SIZE
#define RUDP_IP_CHANNEL_RECV_THREAD_STACK_SIZE CONFIG_LF_RUDP_IP_CHANNEL_RECV_THREAD_STACK_SIZE
#endif
